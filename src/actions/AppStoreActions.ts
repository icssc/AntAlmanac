...
export const renameSchedule = (scheduleName: string, scheduleIndex: number, scheduleNote: string) => {
    AppStore.renameSchedule(scheduleName, scheduleIndex, scheduleNote);
};
