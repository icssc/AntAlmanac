    ...
    return(
      <AreaChart width={950} height={500} data={data}
            ...
            <defs>
              ...
              <linearGradient id = 'colorwait' x1="0" y1="0" x2="0" y2="1">
                <stop offset = '5%' stopColor = '#edd209' stopOpacity = {.0} />
                <stop offset = '100%' stopColor = '#edd209' stopOpacity = {0} />
              </linearGradient>
              <linearGradient id = 'full' x1="0" y1="0" x2="0" y2="1">
                <stop offset = '5%' stopColor = '#d31027' stopOpacity = {.0} />
                <stop offset = '95%' stopColor = '#d31027' stopOpacity = {0} />
              </linearGradient>
            </defs>
       <XAxis dataKey="name" stroke = 'black' fillOpacity= {1}/>
       <YAxis label={<AxisLabel axisType='yAxis' x  = {15} y = {125} width = {100} height = {150}> Number of People</AxisLabel>} />
       <CartesianGrid strokeDasharray="3 3"/>
         <ReferenceLine y = {0} stroke = 'black'/>
       <Tooltip content={}/>
       <Area name = ' Waitlist' type="monotone" dataKey={this.state.waitName} stroke={waitColor} fillOpacity = {1}
          fill = 'url(#colorwait)'/>
       <Area name = ' Max Enrollment' type = 'monotone' dataKey = 'max' stroke = 'red' fillOpacity = {0}/>
       <Area name = ' Enrolled' type="monotone" dataKey="fullEnroll" stroke={enrolledColor} fillOpacity = {1}
          fill = 'url(#full)' strokeWidth = {2}/>
       <Area legendType = 'none' type="monotone" dataKey="enrolled" stroke={enrolledColor} fillOpacity = {1}
          fill = 'url(#colorenrolled)' strokeWidth = {2}/>
        <Legend verticalAlign="bottom" height={36} onClick = {this.handleOnClick}
        payload={
        [
        { id: 'maxenroll', value: 'Max Enrollment', type: 'line', color: 'red'},
        { id: 'enrolled', value: 'Enrolled', type: 'line', color: `${enrolledColor}`},
        { id: 'waitlist', value: 'Waitlist', type: 'line', color: `${waitColor}`},
        ]
        }/>
