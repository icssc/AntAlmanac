...
import type { Course, RepeatingCustomEvent } from '$lib/types';
        ...
        const calendarEventsForCourse = course.section.meetings
            ...
            .map((meeting) => {
                ...
                const calendarEventsMeeting = ['Su', 'M', 'Tu', 'W', 'Th', 'F', 'Sa'].map((day, index) => {
                    ...
                    /**
                     * TODO, FIXME: please remove this once peterportal updated
                     */
                    const bldg = typeof meeting.bldg === 'string' ? meeting.bldg : meeting.bldg.join(',');
    ...
    const finalsForAllCourses = courses
        ...
        .map((course) => {
            ...
            const finalsForCourse = ['Sat', 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri'].map((day, index) => {
                ...
                const meeting = course.section.meetings[0];
