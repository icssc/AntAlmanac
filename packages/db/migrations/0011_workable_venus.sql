...
ALTER TABLE "accounts" ADD COLUMN IF NOT EXISTS "access_token" text;--> statement-breakpoint
ALTER TABLE "accounts" ADD COLUMN IF NOT EXISTS "refresh_token" text;--> statement-breakpoint
...
ALTER TABLE "accounts" ADD COLUMN IF NOT EXISTS "updated_at" timestamp DEFAULT (CURRENT_TIMESTAMP);--> statement-breakpoint
ALTER TABLE "sessions" ADD COLUMN IF NOT EXISTS "created_at" timestamp DEFAULT now() NOT NULL;--> statement-breakpoint
ALTER TABLE "sessions" ADD COLUMN IF NOT EXISTS "updated_at" timestamp DEFAULT (CURRENT_TIMESTAMP);--> statement-breakpoint
