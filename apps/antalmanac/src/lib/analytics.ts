...
/**
 * Wrapper around ReactGA4.event so we don't have to import it everywhere
 */
...
/**
 * all category names and associated actions for Google Analytics
 */
const analyticsEnum = {
    calendar: {
        title: 'Calendar Pane',
...
export type analyticsEnum = typeof analyticsEnum
