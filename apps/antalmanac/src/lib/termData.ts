...
/**
 * interface for describing a school term
 */
interface Term {
...
/**
 * implementation for school term
 */
class Term {
    constructor(shortName: Term['shortName'], longName: Term['longName'], startDate?: Term['startDate']) {
 ...
 * @see {@link https://www.reg.uci.edu/calendars/quarterly/2022-2023/quarterly22-23.html}
 * @remarks months are 0-indexed
 */
const termData = [
 ...
 */
const getDefaultTerm = () => termData[defaultTerm]
