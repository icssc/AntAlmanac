import { makeUniquePlanName, normalizeQuarterName } from '$planner/helpers/planner';

import './ImportTranscriptPopup.scss';
import { addPlanner } from '$planner/helpers/roadmapEdits';
import { VisuallyHiddenInput } from '$planner/helpers/styling';
import { markTransfersAsUnread } from '$planner/helpers/transferCredits';
import { searchAPIResults } from '$planner/helpers/util';
...
import { getNextPlannerTempId, reviseRoadmap, selectAllPlans, setPlanIndex } from '$planner/store/slices/roadmapSlice';
import {
...
import { type BatchCourseData, type PlannerQuarterData, type PlannerYearData } from '$planner/types/types';
...
import { quarters } from '@packages/planner-types';
                    ...
                    <Box component="form" noValidate>
                        ...
                        <ol>
                            <li>
                                Go to{' '}
                                <a
                                    href="https://www.reg.uci.edu/access/student/transcript/?seg=U"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Student Access
