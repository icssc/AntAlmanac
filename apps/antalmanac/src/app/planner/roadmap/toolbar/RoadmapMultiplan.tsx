'use client';
import { makeUniquePlanName } from '$planner/helpers/planner';
import { addPlanner, deletePlanner, reorderPlannersRevision, updatePlannerName } from '$planner/helpers/roadmapEdits';
import { planSortable } from '$planner/helpers/sortable';
...
import { theme } from '$planner/style/theme';
import { type RoadmapPlan } from '$planner/types/roadmap';
            ...
            <Dialog open={delIdx !== -1} onClose={() => setDelIdx(-1)} fullWidth>
                ...
                <DialogContent>
                    <Box component="form" noValidate>
                        <DialogContentText>
                            Are you sure you want to {allPlans.length === 1 ? 'clear' : 'delete'} the roadmap "
                            {newPlanName}"?
                        </DialogContentText>
                    </Box>
                </DialogContent>
