...
import { type TransferredUncategorized } from '@packages/planner-types';
...
const UncategorizedCreditsSection: FC = () => {
    ...
    return (
        <MenuSection title="Elective Credits">
            <SectionDescription>
                Elective credits count towards your total units but will not clear prerequisites. If an item should
                clear prerequisites, consider adding its UCI equivalent in the Courses or AP Exams section instead.
            </SectionDescription>
