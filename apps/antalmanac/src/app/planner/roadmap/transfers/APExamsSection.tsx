...
import { type APExam, type TransferredAPExam } from '@packages/planner-types';
    ...
    const renderTree = (tree: CoursesGrantedTree): React.ReactNode => {
        ...
        if ('OR' in tree) {
            ...
            return (
                <span>
                    <RewardsSelect
                        selectedIndex={selectedReward?.selectedIndex ?? 0}
                        options={options}
        ...
        <MenuSection title="AP Exam Credits">
            ...
            <div className="ap-import-row">
                ...
                <Autocomplete
                    ...
                    renderInput={(params) => (
                        <TextField {...params} variant="outlined" size="small" placeholder="Score" />
                    )}
                />
            </div>
        </MenuSection>
