...
import { Icon, type MenuProps, TextField } from '@mui/material';
...
import { type FilterOptions, levels } from '../../helpers/searchFilters';
import { useAppDispatch, useAppSelector } from '../../store/hooks';
import { selectCourseFilters, setCourseFilters } from '../../store/slices/searchSlice';
            ...
            {Object.entries(departments).map(([code, name]) => {
                ...
                return (
                    <MenuItem
                        key={code}
                        value={code}
                        className={`search-filter-item ${!matchesFilter ? 'hidden' : ''}`}
                    >
