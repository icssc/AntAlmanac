 ...
 */
const HELP_BOX_ACTIVE_MONTH_INDICES = [
    false,
    true,
    true,
    false,
...
export const useHelpMenuStore = create<HelpMenuStoreProps>((set) => {
    ...
    const dismissedRecently =
        helpBoxDismissalTime !== null &&
        Date.now() - parseInt(helpBoxDismissalTime) < 30 * 24 * 3600 * 1000;
    const shouldShowHelpBox =
        !dismissedRecently && !!HELP_BOX_ACTIVE_MONTH_INDICES.at(currentMonthIndex);
