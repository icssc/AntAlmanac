...
export const colorVariants: Record<SectionColorSetting, Record<string, string[]>> = {
    ...
    legacy: {
        blue: [blue[500], blue[400], blue[100], blue[400], blue[500]],
        pink: [pink[500], pink[400], pink[100], pink[400], pink[500]],
        purple: [purple[500], purple[400], purple[100], purple[400], purple[500]],
        green: [green[500], green[400], green[100], green[400], green[500]],
        amber: [amber[500], amber[400], amber[100], amber[400], amber[500]],
        deepPurple: [deepPurple[500], deepPurple[400], deepPurple[100], deepPurple[400], deepPurple[500]],
        deepOrange: [deepOrange[500], deepOrange[400], deepOrange[100], deepOrange[400], deepOrange[500]],
    },
    catppuccin: {
