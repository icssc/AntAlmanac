...
const input = {
    ...
    TemplateContent: {
        ...
        <p>Do you no longer want to receive notifications for this course? <a href="https://antalmanac.com/">Click here to go to AntAlmanac to manage your notification subscriptions</a></p>
