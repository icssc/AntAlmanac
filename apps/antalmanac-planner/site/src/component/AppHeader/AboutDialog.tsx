...
const AboutDialog = ({ open, onClose }: AboutDialogProps) => {
    // TODO: (@CadenLee2) decide whether the PeterPortal contributor graph should also be shown
    return (
        <Dialog open={open} onClose={onClose} className="about-dialog" maxWidth="md" fullWidth>
            ...
            <DialogContent>
                <DialogContentText>
                    ...
                    <br />
                    <br />
                    AntAlmanac Planner was originally created in 2020 as{' '}
                    <Link
                        color="secondary"
                        target="_blank"
                    ...
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://github.com/icssc/antalmanac/graphs/contributors"
                    >
