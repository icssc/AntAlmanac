...
const AdminProfileLinks = ({ pathname, onClose }: AdminProfileLinksProps) => {
    return (
        <>
            <ListItem>
                <ListItemButton
                    className={'profile-popover__link' + (pathname === '/planner/admin/verify' ? ' active' : '')}
            ...
            <ListItem>
                <ListItemButton
                    className={'profile-popover__link' + (pathname === '/planner/admin/reports' ? ' active' : '')}
    ...
    return (
        <List className="profile-popover-links">
            ...
            {isLoggedIn ? (
                ...
                <ListItem>
                    <ListItemButton href={'/api/planner/auth/google'} className="profile-popover-link" component="a">
                        <ListItemIcon>
                            <AccountCircleIcon />
                        </ListItemIcon>
