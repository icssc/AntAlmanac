        ...
        return (
            <FormControl fullWidth>
                ...
                >
                    ...
                    <MenuItem value={'2019 Summer10wk'}>
                        2019 10-wk Summer
                    </MenuItem>
                    <MenuItem value={'2019 Summer1'}>
                        2019 Summer Session 1
                    </MenuItem>
                    <MenuItem value={'2019 Spring'}>
                        2019 Spring Quarter
                    </MenuItem>
                    ...
                    <MenuItem value={'2018 Summer2'}>
                        2018 Summer Session 2
                    </MenuItem>
                    <MenuItem value={'2018 Summer10wk'}>
                        2018 10-wk Summer
                    </MenuItem>
                    <MenuItem value={'2018 Summer1'}>
                    ...
                    <MenuItem value={'2017 Summer2'}>
                        2017 Summer Session 2
                    </MenuItem>
                    <MenuItem value={'2017 Summer10wk'}>
                        2017 10-wk Summer
                    </MenuItem>
                    <MenuItem value={'2017 Summer1'}>
                        2017 Summer Session 1
                    </MenuItem>
                    <MenuItem value={'2017 Spring'}>
                        2017 Spring Quarter
                    </MenuItem>
                    <MenuItem value={'2017 Winter'}>
                        2017 Winter Quarter
                    </MenuItem>
                    <MenuItem value={'2016 Fall'}>2016 Fall Quarter</MenuItem>
                    <MenuItem value={'2016 Summer2'}>
                        2016 Summer Session 2
                    </MenuItem>
                    <MenuItem value={'2016 Summer10wk'}>
                        2016 10-wk Summer
                    </MenuItem>
                    <MenuItem value={'2016 Summer1'}>
                        2016 Summer Session 1
                    </MenuItem>
                    <MenuItem value={'2016 Spring'}>
                        2016 Spring Quarter
                    </MenuItem>
                    <MenuItem value={'2016 Winter'}>
                        2016 Winter Quarter
                    </MenuItem>
                    <MenuItem value={'2015 Fall'}>2015 Fall Quarter</MenuItem>
                    <MenuItem value={'2015 Summer2'}>
                        2015 Summer Session 2
                    </MenuItem>
                    <MenuItem value={'2015 Summer10wk'}>
                        2015 10-wk Summer
                    </MenuItem>
                    <MenuItem value={'2015 Summer1'}>
                        2015 Summer Session 1
                    </MenuItem>
                    <MenuItem value={'2015 Spring'}>
                        2015 Spring Quarter
                    </MenuItem>
                    <MenuItem value={'2015 Winter'}>
                        2015 Winter Quarter
                    </MenuItem>
