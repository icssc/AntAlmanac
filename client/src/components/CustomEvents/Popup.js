...
class DialogSelect extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            days: {
                monday: this.props.event
                    ? this.props.event.days.includes('M')
                    : false,
                ...
                thursday: this.props.event
                    ...
                    : false,
                friday: this.props.event
                    ? this.props.event.days.includes('F')
                    : false,
            },
            anchorEl: null,
    ...
    handleAddToCalendar = (scheduleIndex) => {
        ...
        Object.keys(this.state.days).forEach((day) => {
            if (this.state.days[day]) {
                events.push({
                    color: this.props.editMode
                        ? this.props.event.color
                        : '#551a8b',
